...
public class SdCardUtils {
	// 获取rom内存剩于的运行空间
	public static long rom_freeSpace = Environment.getDataDirectory().getFreeSpace()  / 1024;
	// 获取sd卡的剩于空间
	public static long sd_freeSpace = Environment.getExternalStorageDirectory().getFreeSpace() /1024;
