...
public class Encrypt3DES {
	...
	private static class SingletonHolder {
		private final static Encrypt3DES INSTANCE = new Encrypt3DES(
				strDefaultKey);
	}
	...
	private Encrypt3DES(String strKey) {
		Security.addProvider(new SunJCE());// com.sun.crypto.provider.SunJCE()
		try {
	...
	public static void main(String[] args) {
		...
		// JFinal.start("C:\\Users\\Administrator\\Desktop\\onlyWeb\\webShareHome\\ShareHome\\WebRoot",
		// 8080, "/ShareHome", 5);
	}
}